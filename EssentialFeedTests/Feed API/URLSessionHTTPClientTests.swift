...
class URLSessionHTTPClient: HTTPClient {
    ...
    func get(from url: URL, competion completion: @escaping (HTTPClientResult) -> Void) {
...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_failsOnAllInvalidRepresenatationCases() {
    ...
    private class URLProtocolStub: URLProtocol {
        ...
        static func observe(observer: @escaping ((URLRequest) -> Void)) {
        ...
        override func stopLoading() { } // print("Stopped")}
    }
}
